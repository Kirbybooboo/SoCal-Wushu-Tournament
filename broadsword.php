...
$retrieveAll = "SELECT id, firstName, lastName, gender, birthDate, level from cBroadsword";
...
if(isset($_REQUEST['submit'])) {
    ...
    if (!$err) {
        ...
        $insertScore="UPDATE cBroadsword SET score1=$scores[0], score2=$scores[1], score3=$scores[2], score4=$scores[3], score5=$scores[4], scoreTotal=$scoreTotal WHERE id=$firstID";
  ...
  <header>
    <nav class="indigo" role="navigation" style="height: 144px">
      <div class="nav-wrapper container">
        <a class="page-title" id="eventTitle">Broadsword</a>
      </div>
    </nav>
  ...
  <main>
    ...
    <div class="container">
      ...
      <ul id="dropdown1" class="dropdown-content">
        <li><a onclick="changeDivision('cBroadsword','advance','female','adult')">AFA</a></li>
        <li><a onclick="changeDivision('cBroadsword','advance','male','adult')">AMA</a></li>
        <li><a onclick="changeDivision('cBroadsword','advance','female','child')">AFC</a></li>
        <li><a onclick="changeDivision('cBroadsword','advance','male','child')">AMC</a></li>
        <li><a onclick="changeDivision('cBroadsword','advance','female','teen')">AFT</a></li>
        <li><a onclick="changeDivision('cBroadsword','advance','male','teen')">AMT</a></li>
        <li class="divider"></li>
        <li><a onclick="changeDivision('cBroadsword','beginner','female','adult')">BFA</a></li>
        <li><a onclick="changeDivision('cBroadsword','beginner','male','adult')">BMA</a></li>
        <li><a onclick="changeDivision('cBroadsword','beginner','female','child')">BFC</a></li>
        <li><a onclick="changeDivision('cBroadsword','beginner','male','child')">BMC</a></li>
        <li><a onclick="changeDivision('cBroadsword','beginner','female','teen')">BFT</a></li>
        <li><a onclick="changeDivision('cBroadsword','beginner','male','teen')">BMT</a></li>
        <li class="divider"></li>
        <li><a onclick="changeDivision('cBroadsword','intermediate','female','adult')">IFA</a></li>
        <li><a onclick="changeDivision('cBroadsword','intermediate','male','adult')">IMA</a></li>
        <li><a onclick="changeDivision('cBroadsword','intermediate','female','child')">IFC</a></li>
        <li><a onclick="changeDivision('cBroadsword','intermediate','male','child')">IFC</a></li>
        <li><a onclick="changeDivision('cBroadsword','intermediate','female','teen')">IFT</a></li>
        <li><a onclick="changeDivision('cBroadsword','intermediate','male','teen')">IMT</a></li>
      </ul>
      <a class='dropdown-button btn' href="#" data-activates='dropdown2'>Competitor</a>
      <ul id="dropdown2" class="dropdown-content">
<?php
  echo "<li><a onclick='changeCompetitor(\"cBroadsword\", ".$firstID.")'>".$firstFirstName." ".$firstLastName."</a></li>";
  if (mysqli_num_rows($resultAll) > 0) 
  {
      while($row = mysqli_fetch_assoc($resultAll)) 
      {
      echo "<li><a onclick='changeCompetitor(\"cBroadsword\", ".$row['id'].")'>".$row['firstName']." ".$row['lastName']."</a></li>";
      }
  }
      echo "</ul>";
      echo "<br>";

$retrieveFirst = "SELECT id, firstName, lastName, gender, birthDate, level FROM cBroadsword WHERE id=$firstID";
