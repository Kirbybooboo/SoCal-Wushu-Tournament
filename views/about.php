                ...
                <div class="col-lg-12">
                    <div class="intro-message">
                        ...
                        <ul class="list-inline intro-social-buttons">
                            <li>
                                <a href="views/register.php#register" class="btn btn-default btn-lg"><span class="network-name">Register</span></a>
                            </li>
                            <li>
                                <a href="views/volunteer.php#register" class="btn btn-default btn-lg"><span class="network-name">Volunteer</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
